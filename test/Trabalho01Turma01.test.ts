import { GerenciadorDeTarefas, Tarefa } from "../src/Trabalho01Turma01";
...
describe('GerenciadorDeTarefas', () => {
  ...
  test('Deve adicionar uma tarefa', () => {
    const tarefa = { id: 1, descricao: 'Tarefa 1', concluida: false } as Tarefa;
  ...
  test('Validação de Erro ao cadastrar tarefa', () => {
    const tarefa = { id: 1, descricao: 'tes', concluida: false } as Tarefa;
    expect(() => {
      gerenciador.adicionarTarefa(tarefa);
